    ...
    <main className=" flex-1 overflow-scroll p-2 lg:p-5 bg-gradient-to-bl from-white to-indigo-600">
      <div className="bg-white py-24 sm:py32 rounded-md drop-shadow-xl">
        ...
        <div className="mx-auto mt-16 max-w-7xl px-6 sm:mt-20 md:mt-24 lg:px-8">
          <dl className="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base leading-7 text-grau-600 sm:grid-cols-2 lg-mx-0 lg:max-w-none lg:grid-cols-3 lg-gap-x-0 lg:hgap-y-16">
